        ...
        <Box className="p-5 w-100">
          <Box>
            <div
              ...
              style={{ fontSize: 36, color: "#045538" }}
            >
              Welcome to BAJO’S
            </div>
            <br />
            <div
              className="text-center"
              style={{ fontSize: 20, color: "#8E8E8E" }}
            >
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris
              morbi
              <br /> dictum aliquam vel tristique non purus. Magna eu ultricies
              turpis sit
              <br /> imperdiet. Enim ultrices in at risus, dictum sagittis
              mauris est.
            </div>
          </Box>
          <br />
